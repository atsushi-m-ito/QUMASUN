...
inline
void QUMASUN_KPOINT::mScatterField(double* local_dest, const double* global_src) {
	ScatterGrid(ml_grid, local_dest, m_global_grid, global_src, m_root_id);
}

inline
void QUMASUN_KPOINT::mGatherField(double* global_dest, const double* local_src) {	
	GatherGrid(m_global_grid, global_dest, ml_grid, local_src, m_root_id);
}


inline
void QUMASUN_KPOINT::mScatterField_HR(double* local_dest, const double* global_src) {
    ScatterGrid(ml_grid, local_dest, m_global_grid, global_src, m_root_id, m_HR_ratio_x, m_HR_ratio_y, m_HR_ratio_z);
}

inline
void QUMASUN_KPOINT::mGatherField_HR(double* global_dest, const double* local_src) {
...
*/
inline
void QUMASUN_KPOINT::mHierarchyGatherField(double* global_dest, const double* local_src) {
...
*/
inline
void QUMASUN_KPOINT::mHierarchyScatterField(double* local_dest, const double* global_src) {
