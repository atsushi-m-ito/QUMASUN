...
inline
double QUMASUN_KPOINT::mGetTotalEnergy() {
...
//mpi supported//
inline
double QUMASUN_KPOINT::mGetEnergyKinetic() {
...
inline
double QUMASUN_KPOINT::mGetEnergy_V_rho(const double* V, const double* rho) {
...
inline
double QUMASUN_KPOINT::mGetEnergy_V_rho_HR(const double* V, const double* rho) {
...
//mpi supported//
inline
double QUMASUN_KPOINT::mGetEnergyExtByVextRho() {
	const double EV = mGetEnergy_V_rho(ml_Vext, ml_rho);
	return EV;
}

inline
double QUMASUN_KPOINT::mGetEnergyExtByVextRho_HR() {
...
*/
inline
double QUMASUN_KPOINT::mGetEnergyHartree() {
...
*/
inline
double QUMASUN_KPOINT::mGetEnergyExtByVhartNuclRho() {
	const double EV = mGetEnergy_V_rho(ml_Vhart, ml_nucl_rho);
	return EV;
}

inline
double QUMASUN_KPOINT::mGetEnergyExtByVhartNuclRho_HR() {
    const double EV = mGetEnergy_V_rho_HR(ml_hr_Vhart, ml_hr_nucl_rho);
    return EV;
}

inline
double QUMASUN_KPOINT::mGetEnergyCoreCoreNuclDensity() {
...
inline
double QUMASUN_KPOINT::mGetEnergyCoreCoreNuclDensity_HR() {
...
//mpi supported//
inline
double QUMASUN_KPOINT::mGetEnergyXC(double* pEx, double* pEc, double* pVxRho, double* pVcRho) {
	const int64_t size_3d = ml_grid.Size3D();
...
//mpi supported//
inline
double QUMASUN_KPOINT::mGetEnergyXCSpin(double* pEx, double* pEc, double* pVxRho_up, double* pVcRho_up, double* pVxRho_down, double* pVcRho_down) {
	const int64_t size_3d = ml_grid.Size3D();
	const auto& rho = ml_rho;
	const auto& pcc_rho = ml_pcc_rho;
...
//mpi supported//
inline
double QUMASUN_KPOINT::mGetEnergyPseudoNonlocal() {
	double EV = 0.0;
	for (int sk = 0; sk < m_num_having_spin_kpoint; ++sk) {
...
inline
double QUMASUN_KPOINT::mGetEnergyCoreCore_direct() {
	double EV = 0.0;
...
inline
double QUMASUN_KPOINT::mGetEnergyPotentialAtNucl(const double* V) {
	double EV = 0.0;
...
inline
double QUMASUN_KPOINT::mGetEnergyCoreCoreByVextAtPoint() {
	double EV = mGetEnergyPotentialAtNucl(m_Vext.Pointer());
	return EV / 2.0;
}

inline
double QUMASUN_KPOINT::mGetEnergyExtByVhartAtPoint() {
