...
*/
inline
void QUMASUN_KPOINT::mHamiltonianMatrix_ddm(SoAComplex& l_Hp, const double* l_Vtot, const SoAComplex& l_phi, int kpoint_x, int kpoint_y, int kpoint_z, int id_spin_kpoint) {
#define ZERO_CLEAR
#ifdef ZERO_CLEAR
...
inline
void QUMASUN_KPOINT::mKineticMatrixAdd_ddm(double* Kp, const double* p) {
...
inline
void QUMASUN_KPOINT::mKineticMatrixAdd_ddm_kpint(SoAComplex& Kp, const SoAComplex& p, int kpoint_x, int kpoint_y, int kpoint_z) {
...
inline
void QUMASUN_KPOINT::mPotentialMatrix_ddm(double* Vp, const double* V, const double* p) {
