...
inline
void QUMASUN_TD::mSetDensityOne(GridRange& l_grid, double* l_rho, const SoAComplex* l_psi, const double* occupancy, int num_solution) {
...
//mpi supported//
inline
double QUMASUN_TD::mSetDensity(bool is_mixing) {
